...
[QuantumESPRESSOParser](https://github.com/MineralsCloud/QuantumESPRESSOParser.jl).
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("QuantumESPRESSOParser")
   ```

3. Run

   ```julia-repl
   julia> using QuantumESPRESSOParser
   ```
...
version of QuantumESPRESSOParser, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuantumESPRESSOParser.jl"
```

in the second step above.

## Update QuantumESPRESSOParser
...
our [GitHub repository](https://github.com/MineralsCloud/QuantumESPRESSOParser.jl)
for new releases.
Once we release a new version, you can update QuantumESPRESSOParser by typing

```@repl
using Pkg
Pkg.update("QuantumESPRESSOParser")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall QuantumESPRESSOParser
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("QuantumESPRESSOParser")

   julia> Pkg.gc()
   ```

2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall QuantumESPRESSOParser.
